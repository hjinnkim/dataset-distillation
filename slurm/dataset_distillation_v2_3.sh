...
python main.py --mode distill_basic --dataset Cifar10_simCLR --arch ResNet18SimCLR --distilled_images_per_class_per_step 8 --results_dir ./results_v2_3/