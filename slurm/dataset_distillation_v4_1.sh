...
python main.py --mode distill_basic --dataset Cifar10_simCLR --arch ResNet18SimCLR --distill_epochs 10 --distilled_images_per_class_per_step 8  --results_dir ./results_v4_1/ 