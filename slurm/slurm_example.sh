#!/bin/sh
#SBATCH -J dataset-distillation ## Job Name
...
#SBATCH --time 2:00:00  ## 최대 작업 시간(Wall Time Clock Limit)
#SBATCH --gres=gpu:1 ## number of GPU(s) per node


source activate torch38
python main.py --mode distill_basic --dataset Cifar10_simCLR --arch ResNet18SimCLR